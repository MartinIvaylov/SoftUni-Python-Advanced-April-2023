def move_function(direction, steps):
...
for _ in range(int(input())):
    ...
    if command_info[0] == "move":
        my_position = move_function(command_info[1], int(command_info[2]))
    elif command_info[0] == "shoot":
        target_down_pos = shoot_function(command_info[1])
